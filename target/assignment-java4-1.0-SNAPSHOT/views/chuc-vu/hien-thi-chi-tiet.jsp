...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<c:url value="/chuc-vu/${action}"/>" method="post" class="needs-validation" novalidate>
                        <div class="mb-3 row">
                            <label for="inputMa" class="col-sm-2 col-form-label">Ma</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputMa" name="ma" value="${chucVu.ma}" required>
                        ...
                        <input type="text" class="form-control d-none" name="id" value="${chucVu.id}">
