...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<c:url value="/san-pham/${action}"/>" method="post">
                        <div class="mb-3 row">
                            <label for="inputMa" class="col-sm-2 col-form-label">Ma</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputMa" name="ma" value="${sanPham.ma}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <input type="text" class="form-control d-none" name="id" value="${sanPham.id}">
