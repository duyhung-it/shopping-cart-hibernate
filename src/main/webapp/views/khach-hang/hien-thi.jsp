        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="<c:url value="/khach-hang/add"/>" class="btn btn-danger mb-2"><i
                                    class="mdi mdi-plus-circle mr-2"></i> Thêm khách hàng</a>
                        </div>
                        <div class="col-sm-8">
                                        ...
                                        <c:forEach var="item" items="${list}">
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="table-action">
                                                    <a href="<c:url value="/khach-hang/detail?id=${item.id}"/>"
                                                       class="action-icon"> <i
                                                            class="mdi mdi-eye"></i></a>
                                                    <a href="<c:url value="/khach-hang/delete?id=${item.id}"/>"
                                                       class="action-icon"> <i
