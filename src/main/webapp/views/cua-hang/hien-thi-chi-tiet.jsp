...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<c:url value="/cua-hang/${action}"/>" method="post">
                        <div class="mb-3 row">
                            <label for="inputMa" class="col-sm-2 col-form-label">Mã</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputMa" name="ma" value="${cuaHang.ma}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label  class="col-sm-2 col-form-label">Dịa chỉ</label>
                            <div class="col-sm-10">
                        ...
                        <div class="mb-3 row">
                            <label  class="col-sm-2 col-form-label">Quôc gia</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="quocGia" value="${cuaHang.quocGia}">
                            </div>
                        </div>
                        <input type="text" class="form-control d-none" name="id" value="${cuaHang.id}">
